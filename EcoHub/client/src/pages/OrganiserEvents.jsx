...
function OrganiserEvents() {
    ...
    const getEvents = (filter, searchQuery) => {
        ...
        http.get(`/organiser/event${filterQuery}`)
            .then(res => {
    ...
    const rows = events.map((event) => ({
        ...
        attendance: (
            <button
                onClick={() => navigate(`/organiser/event/${event.event_id}/attendance`)}
                className="text-blue-500 hover:underline"
            >
                Attendance
            </button>
        ...
        <div className="flex">
            ...
            <div className="w-64 bg-white shadow-md p-4 fixed shadow-md rounded-lg">
                ...
                <ul className="space-y-2">
                    ...
                    <li>
                        <button
                            onClick={() => navigate('/organiser/rewards')}
                            className="w-full text-left p-2 rounded hover:bg-gray-100"
                        >
                            Rewards
                        </button>
            ...
            <div className="flex-1 ml-64 p-4">
                <div className="container mx-auto mt-8 p-4 bg-white shadow-md rounded-lg">
                    <h1 className="text-4xl font-bold mb-6">Organiser Event Management</h1>
