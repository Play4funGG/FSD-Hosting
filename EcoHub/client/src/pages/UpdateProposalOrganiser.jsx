...
function UpdateProposalOrganiser() {
    ...
    useEffect(() => {
        ...
        http.get(`/organiser/event/${eventId}`)
            .then(res => {
                ...
                setTitleText(data.event_title || '');
                setDescriptionText(data.event_description || '');
                if (data.imageFile) {
    ...
    const handleSubmit = (e) => {
        ...
        // Set event_status_id to 1 for the update
        finalEventData.event_status_id = 1;
        ...
        // Send PUT request to update proposal
        http.put(`/organiser/event/${eventId}`, formData, {
            ...
            .catch(error => {
                console.error('Error updating proposal:', error.response ? error.response.data : error.message);
    ...
    return (
        <div className="container mx-auto mt-8 p-4 bg-white shadow-md rounded-lg">
            <h1 className="text-4xl font-bold mb-6">Update Proposal</h1>
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <TextField
                        ...
                        margin="normal"
                    />
                    <CharacterCounter text={titleText} maxLength={100} />
                    <TextField
                        ...
                        rows={4}
                    />
                    <CharacterCounter text={descriptionText} maxLength={1000} />
                    <TextField
                        label="Event Date"
                        name="event_date"
                        type="date"
...
export default UpdateProposalOrganiser;
