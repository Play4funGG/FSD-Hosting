...
function UpdateEvent() {
        ...
        http.get(`/admin/event/${eventId}`)
            .then(res => {
                ...
                setEventData({
                    ...
                    event_date: new Date(data.event_date) || new Date(),
    ...
    const handleSubmit = (e) => {
        ...
        // Ensure signup_limit is set to null if it is empty
        if (finalEventData.signup_limit === '') {
            finalEventData.signup_limit = null;
        } else {
            finalEventData.signup_limit = Number(finalEventData.signup_limit);
        }
        ...
        http.put(`/admin/event/${eventId}`, formData, {
            headers: {
                'Content-Type': 'multipart/form-data',
            },
        })
    ...
    const handleDelete = () => {
        http.delete(`/admin/event/${eventId}`)
            .then(() => {
