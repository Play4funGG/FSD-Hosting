...
function AdminAttendance() {
    ...
    const getAttendance = async (eventId) => {
        try {
            const res = await http.get(`/admin/event/${eventId}/attendance`);
    ...
    const handleUpdateAttendance = async () => {
        ...
        try {
            await http.put(`/admin/event/${eventId}/attendance`, { attendanceUpdates: updatedAttendance });
            toast.success('Attendance updated successfully.');
            navigate('/admin/event'); // Navigate back after successful update
        } catch (error) {
